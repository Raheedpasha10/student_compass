# 🚀 MARGDARSHAN - AI-Powered Career Guidance Platform with Enhanced 3D UI
...
![Framer Motion](https://img.shields.io/badge/Framer-Motion-orange?style=flat-square&logo=framer)

A comprehensive AI-powered career guidance platform with enhanced 3D UI effects, advanced animations, and immersive user experience. Helps users discover personalized career paths, learning roadmaps, and educational resources based on their skills and expertise level.
...
- **3D Tilt Effects**: Interactive 3D cards with realistic perspective
- **Advanced Animations**: Smooth transitions using Framer Motion
- **Glow Effects**: Dynamic neon glow effects on interactive elements
- **Floating Elements**: Subtle wavy background animations with floating particles
...
- **Interactive Roadmaps**: Step-by-step learning paths with 3D enhancements
...
- **Enhanced UI Components**: Custom 3D components for improved visual experience

## 🏗️ Architecture

```
MARGDARSHAN/
├── frontend/                 # React.js Frontend with Enhanced UI
│   ├── src/
│   │   ├── components/      # Reusable UI components with 3D effects
│   │   │   ├── Enhanced3DButton.js     # 3D animated buttons
│   │   │   ├── Enhanced3DCard.js       # 3D cards with tilt effects
│   │   │   ├── Enhanced3DResourceCard.js # 3D resource cards
│   │   │   ├── Compass3D.js            # 3D animated compass
│   │   │   └── ...                     # Other components
│   │   ├── pages/           # Main application pages
│   │   │   ├── UltimateRoadmap.js      # Enhanced roadmap with 3D effects
│   │   │   ├── EnhancedRoadmap.js      # Framer Motion enhanced roadmap
│   │   │   └── ...                     # Other pages
...
4. **Set up environment variables**
   ...
   # REACT_APP_YOUTUBE_API_KEY=your_youtube_api_key (optional)
   ```
...
3. **Install additional UI enhancement packages**
   ```bash
...
4. **Explore Enhanced Resources**: 
   ...
   - Experience 3D UI effects on all interactive elements
   - Visualize your path with interactive flowcharts
   - Discover relevant courses and educational content

### Accessing Enhanced UI Pages

The application includes multiple versions of the roadmap with different enhancement levels:
...
Enhanced UI: 3D resource cards, animated buttons, tilt effects on cards
```
...
Enhanced UI: Interactive 3D buttons, floating cards, glow effects
```
...
Enhanced UI: Smooth animations, 3D resource visualization, enhanced transitions
```
...
Enhanced UI: Professional 3D design, medical-themed color scheme, enhanced readability
```
...
- **Animation Performance**: Smooth 60fps animations on modern devices
...
#### UI Enhancements Not Working
- Ensure framer-motion and react-intersection-observer are installed
- Check browser compatibility (modern browsers recommended)
- Verify CSS animations are not disabled in system preferences
...
*MARGDARSHAN - Your guide to a successful career in technology and medicine with enhanced 3D UI experience*